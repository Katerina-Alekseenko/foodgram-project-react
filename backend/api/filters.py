...
class RecipeFilter(filter.FilterSet):
    ...
    is_in_recipe_shopping_cart = filter.NumberFilter(
        method='get_is_recipe_shopping_cart'
    )
    ...
    def get_is_recipe_shopping_cart(self, queryset, name, value):
        user = self.request.user
        if value:
